...
Tail.TailStart(builder)
Tail.TailAddLength(builder, 200)
tail = Tail.TailEnd(builder)
...
Monster.MonsterAddAngry(builder, True)
Monster.MonsterAddTail(builder, tail)
